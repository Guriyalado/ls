    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 mt-4 text-gray-800">Edit Permission</h1>
                <a href="{{route('permissions.index')}}" class="d-none mt-4 d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i

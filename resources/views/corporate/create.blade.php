<div class="modal-dialog modal-lg  position-relative" role="document">
    ...
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('App\Http\Controllers\Industries\IndustryController@store'), 'method' => 'post', 'id' => 'ajax_form', 'enctype' => 'multipart/form-data']) !!}
        @php
            $form = 'create';
        @endphp
        @include('industry.form')
        {!! Form::close() !!}
    </div>
</div>

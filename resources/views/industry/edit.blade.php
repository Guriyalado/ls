        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Industries</h4>
                </div> 
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header bg-white modal-header d-block">
                            <h1 class="h3 mb-0 text-gray-800 float-left">Edit Industry</h1>
                        ...
                        {!! Form::open(['url' => action('App\Http\Controllers\Industries\IndustryController@update', [$industry->id]), 'method' => 'PUT', 'id' => 'ajax_form',  'enctype' => 'multipart/form-data' ]) !!}
